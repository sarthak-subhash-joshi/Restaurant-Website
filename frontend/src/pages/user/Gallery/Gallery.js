    ...
    <>
      <div className="container-gallery">
        ...
        <div className="container-buttons">
          ...
          <button className="gallery-btn" onClick={() => filterItem("lunch")}>
            Lunch
          </button>
          <button className="gallery-btn" onClick={() => filterItem("dinner")}>
            Dinner
          </button>
          {/* <button className='gallery-btn' onClick={() => filterItem("family photos")}>Family Photos</button> */}
          <button className="gallery-btn" onClick={() => setCardMenu(Menu)}>
            All
          </button>
        </div>
