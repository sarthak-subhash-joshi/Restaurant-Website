        ...
        <div className="details-main-container row">
            ...
            <div className="col-lg-6">
              ...
              <div className='landing-page-top'>
               ...
               <p style={{fontSize:'30px'}}><strong>Price : </strong>{item.price}  ₹</p>
               <p style={{fontSize:'30px'}}><strong>Discount : </strong>{item.discount}  %</p>
               <p style={{fontSize:'30px'}}><strong>Description : </strong></p>
